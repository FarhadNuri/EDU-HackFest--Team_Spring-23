      ...
      >
        ...
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">{crop.cropType || crop.name}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{crop.weight || crop.quantity || 'N/A'}</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-lg font-semibold text-gray-900">{formatDate(crop.harvestDate)}</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-lg font-semibold text-gray-900">{crop.storageLocation || crop.location || 'Warehouse A'}</p>
            </div>
